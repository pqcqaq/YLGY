            ...
            if flag:
                ...
                try:
                    headers = {'User-Agent': random.choice(headers_list),
                                't': token.get()}
                    r = requests.get(
                        'https://cat-match.easygame2021.com/sheep/v1/game/game_over?rank_score=100&rank_state=1&rank_time=155&rank_role=1&skin=1',
...
def Rut(result,i):
    if result:
        ...
        lbRut2 = Label(root, text=("等待重试"), font=("黑体", 16)).place(x=16, y=80)
...
try:
    ...
    tkinter.messagebox.showinfo("错误","图标文件丢失，程序将正常启动！")
...
tokenStr = StringVar(value='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2OTQzMzk0MTAsIm5iZiI6MTY2MzIzNzIxMCwiaWF0IjoxNjYzMjM1NDEwLCJqdGkiOiJDTTpjYXRfbWF0Y2g6bHQxMjM0NTYiLCJvcGVuX2lkIjoiIiwidWlkIjo4NDA1NTc3MSwiZGVidWciOiIiLCJsYW5nIjoiIn0.gjHmmP34I8esGXlhDK7AhHuF8Gm95gVDmW7Kyluu3Co')
